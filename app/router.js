...
router.get('/transaction/day',tokenMiddleware, transactionController.getTransactionOfToday);
router.get('/transaction/week',tokenMiddleware, transactionController.getTransactionOfWeek);
router.get('/transaction/month',tokenMiddleware, transactionController.getTransactionOfMonth);
router.get('/transaction/year',tokenMiddleware, transactionController.getTransactionOfYear);
